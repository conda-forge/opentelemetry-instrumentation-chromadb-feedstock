About opentelemetry-instrumentation-chromadb-feedstock
======================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/opentelemetry-instrumentation-chromadb-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/opentelemetry-instrumentation-chromadb-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add opentelemetry-instrumentation-chromadb
# for installing globally
pixi global install opentelemetry-instrumentation-chromadb
```
...
It is possible to list all of the versions of `opentelemetry-instrumentation-chromadb` available on your platform:
...
```
pixi search opentelemetry-instrumentation-chromadb --channel conda-forge
```
